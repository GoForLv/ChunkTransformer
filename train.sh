# Debug
python train.py --model=TorchTransformer --seq_len=1024 --epochs=3 --train_count=1 --debug
python train.py --model=MultiHeadTransformer --seq_len=1024 --epochs=3 --train_count=1 --debug
python train.py --model=MaskTransformer --seq_len=1024 --epochs=3 --train_count=1 --debug
python train.py --model=ChunkTransformer --seq_len=1024 --epochs=3 --train_count=1 --debug
